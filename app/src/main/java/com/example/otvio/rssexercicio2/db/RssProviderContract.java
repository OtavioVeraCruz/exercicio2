...
class RssProviderContract {
    ...
    public static final Uri FEED_CONTENT_URI =
            Uri.withAppendedPath(Uri.parse("content://br.ufpe.cin.if1001.rss.leitura/"), SQLiteRSSHelper.DATABASE_TABLE);

    private static final Uri BASE_RSS_URI = Uri.parse("content://com.example.otvio.rssexercicio2/");

    public static final Uri LIST_URI = Uri.withAppendedPath(BASE_RSS_URI, TABLE_ITEMS);
